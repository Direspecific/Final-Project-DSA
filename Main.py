...
def protract():
    ...
    lithit_main_frame.place(x=(title_frame.winfo_x())+75)
...
def show_main_frame_content(text):
    ...
    if text == "Home":
        ...
        home_lastread_button.configure(state="normal")
...
lRead_frame = customtkinter.CTkFrame(main_content_frame,width=Main_app.winfo_screenwidth(),height=Main_app.winfo_screenheight(),fg_color="#F2E8BD")
